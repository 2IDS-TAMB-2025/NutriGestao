        ...
        <div class="rd-navbar-wrap rd-navbar-modern-wrap">
          ...
          <div class="container">
              ...
              <div class="card">
                  ...
                  <form method="POST" action="../controller/controller_refeicao.php">
                    <input type="number" name="quantidade_diaria" id="quantidade_diaria" placeholder="diaria (Kg)" min="0" 
                          value="<?= isset($dados['quantidade_diaria']) ? $dados['quantidade_diaria'] : '' ?>">
