                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      <li class="rd-nav-item "><a class="rd-nav-link" href="Inicio.php"><b id="link">Início</b></a>
                      </li>
                      <li class="rd-nav-item "><a class="rd-nav-link" href="refeicao.php"><b id="link">Refeições</b></a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="desperdicio.php"><b id="link">Desperdícios</b></a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="contagem.php"><b id="link">Contagem</b></a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="restricoes_dietas.php"><b id="link">Restricões & Dietas</b></a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="cardapio.php"><b id="link">Cardápio</b></a>
                      </li>
                    </ul>
                   ...
                   <div class="profile-container" style="position: relative; margin-left: 20px;">
                      <div class="profile-icon" id="profileIcon" style="width: 40px; height: 40px; background-color: #ff990032; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                        <b style="color: #f89200;"><?= strtoupper(substr($_SESSION['email'], 0, 2)) ?><
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Data do dia: <input type="date" name="<?= $dia ?>_data_manha" value="<?= $data_dia ?>" required data-required></td>
                    </tr>
                    ...
                    <tr><td>Acompanhamento: <input type="text" name="<?= $dia ?>_acompanhamento_manha"></td></tr>
                    <tr><td>Fruta: <input type="text" name="<?= $dia ?>_fruta_manha" required></td></tr>

                    <tr>
                      <td><b>Almoço</b></td>
                      <td>Cardápio: <textarea name="<?= $dia ?>_almoco"></textarea></td>
                    </tr>
                    ...
                    <tr><td>Acompanhamento: <input type="text" name="<?= $dia ?>_acompanhamento_tarde"></td></tr>
                    <tr><td>Fruta: <input type="text" name="<?= $dia ?>_fruta_tarde" required></td></tr>
                  </tbody>
                </table>
              </div>
...
<?php endif; ?>
    ...
    <script>
        ...
        document.getElementById('btnDefinirSemana').addEventListener('click', function() {
          const inputInicio = document.getElementById('inicio_semana');
          const dataInicio = inputInicio.value;
          if (!dataInicio) {
            alert('Por favor, selecione uma data válida para o início da semana.');
            return;
          }
          ...
          dias.forEach((dia, i) => {
            ...
            // Atualiza texto do cabeçalho do card
            const spanData = document.getElementById('data_' + dia);
            if(spanData) spanData.textContent = dataFormatada;

            // Atualiza valor do input date dentro do card
