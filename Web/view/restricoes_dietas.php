...
<html class="wide wow-animation" lang="en">
  <head>
    <title>NutriGestão-Restrição e Dieta</title>
        ...
        <form method="POST" action="../controller/controller_restricao_alimentar.php" enctype="multipart/form-data">
          ...
          <div class="text-right mt-6" style="display:flex; justify-content: flex-end;">
            ...
            <div
              ...
              class="text-white font-semibold py-2 px-6 rounded-lg hover:brightness-90"
            >
              <a href="./tabela_restricoes.php?unidade_escolar=<?php echo $_GET["unidade_escolar"];?>" style="color: white;">Tabela de alunos com restrições</a>
            </div>
          </div>
        </form>
      </main>
